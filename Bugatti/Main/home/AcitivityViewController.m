...
@interface AcitivityViewController ()<UITableViewDelegate,UITableViewDataSource>
...
//    introduceLab.text = @"活动详情";
//    [self.view addSubview:introduceLab];
//    [introduceLab mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(introduceLab.superview).with.offset(NAV_BOTTOM+10);
//        make.left.equalTo(introduceLab.superview).with.offset(VIEW_PACE);
//    }];
    
//    [self.view addSubview:self.textView];
    [self addGrayBackbutton];
    UITableView *tab = [[UITableView alloc]initWithFrame:CGRectMake(0, NAV_BOTTOM, SCREEN_WIDTH, SCREEN_HEIGHT-NAV_BOTTOM) style:UITableViewStylePlain];
    tab.delegate = self;
    tab.dataSource = self;
    tab.tableHeaderView = self.textView;
